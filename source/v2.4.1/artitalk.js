...
var cssDark = "@media (prefers-color-scheme:dark){.cbp_tmtimeline>li:nth-child(odd) .cbp_tmlabel{background:#444}.cbp_tmtimeline>li .cbp_tmlabel{background:#444}.cbp_tmtimeline>li:nth-child(odd) .cbp_tmlabel:after{border-right-color:#444}.cbp_tmtimeline>li .cbp_tmlabel:after{border-right-color:#444}.at_button{background:#444}.at_button:hover{background:#333}#shuoshuo-modal,#userinfo{background:#333}#shuoshuo-modal pre{background:#333;border:none}.shuoshuo_inputs,.shuoshuo_text{background-color:#444}#shuoshuo_input,.power{padding:0 10px}#artitalk_main{border-radius:5px}}";
if (typeof(dark_mode) != "undefined" && dark_mode==1) {
    css = css+cssDark;
}
